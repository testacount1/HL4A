...
public final class AcpOptions {
    ...
    public static class Builder {
        ...
        private static final String DEF_DENIED_MESSAGE = "应用将不能正常使用，您可以去设置页面重新授权";
        private static final String DEF_DENIED_CLOSE_BTN_TEXT = "关闭";
        private static final String DEF_DENIED_SETTINGS_BTN_TEXT = "设置";
        private static final String DEF_RATIONAL_BTN_TEXT = "了解";
