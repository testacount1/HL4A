...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="let|var|const|null||and|break|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|then|true|until|while|=|+|!|^|~";
