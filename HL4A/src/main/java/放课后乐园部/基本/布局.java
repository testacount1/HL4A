...
public class 布局 {
    ...
    public static void 打开(final Activity $界面,final View $布局) { 
        final 线性布局 $底层 = new 线性布局($界面)
            .置主题("底层")
            .加入子元素(new 线性布局($界面)
                   .置背景颜色(主题.状态栏())
                   .置宽度("最大")
    ...
    public static void 打开实现(Activity $界面,View $布局) {
        ...
        $界面.setContentView($布局);
        
    }

    public static void 打开(Activity $界面,基本视图 $视图) {
        $视图.打开($界面);
    }
