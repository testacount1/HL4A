...
public final class 文件 {
    ...
    static {
        ...
        替换地址(new String[][] {
                 {"图片.返回","@lib/icon/ic_back.png"},
                 {"图片.安卓","@lib/icon/ic_android.png"},
                 {"图片.菜单","@lib/icon/ic_menu.png"},
                 {"图片.复制","@lib/icon/ic_copy.png"},
                 {"图片.更多","@lib/icon/ic_more.png"},
                 {"图片.设置","@lib/icon/ic_setting.png"},
                 {"图片.分享","@lib/icon/ic_share.png"},
                 {"图片.发送","@lib/icon/ic_send.png"},
                 {"图片.添加","@lib/icon/ic_add.png"},
                 {"图片.前进","@lib/icon/ic_forward.png"},
                 {"图片.回退","@lib/icon/ic_backspace.png"},
                 {"图片.剪切","@lib/icon/ic_cut.png"},
                 {"图片.图片","@lib/icon/ic_icon.png"},
                 {"图片.删除","@lib/icon/ic_delete.png"},
                 {"图片.编辑","@lib/icon/ic_edit.png"},
                 {"图片.邮件","@lib/icon/ic_email.png"},
                 {"图片.启动","@lib/icon/ic_play.png"},
                 {"图片.公开","@lib/icon/ic_public.png"},
                 {"图片.重做","@lib/icon/ic_redo.png"},
                 {"图片.撤销","@lib/icon/ic_undo.png"},
                 {"图片.全选","@lib/icon/ic_select.png"},
                 {"图片.粘贴","@lib/icon/ic_paste.png"},
                 {"图片.日志","@lib/icon/ic_log.png"},
                 {"图片.卡片","@lib/icon/ic_sdcard.png"},
                 {"图片.搜索","@lib/icon/ic_search.png"}
             });
