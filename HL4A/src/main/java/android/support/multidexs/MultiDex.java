    ...
    public static void install(Context context) {
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            try {
                ...
                throw new RuntimeException("Multi dex installation failed (" + 错误.取整个错误(var11) + ").");
            }
        }
    }
