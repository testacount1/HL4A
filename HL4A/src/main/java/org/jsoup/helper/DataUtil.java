...
public final class DataUtil {
     ...
     */
    public static 文档 load(File in, String charsetName, String baseUri) throws IOException {
     ...
     * @throws IOException on IO error
     */
    public static 文档 load(InputStream in, String charsetName, String baseUri) throws IOException {
     ...
     * @throws IOException on IO error
     */
    public static 文档 load(InputStream in, String charsetName, String baseUri, Parser parser) throws IOException {
    ...
    static 文档 parseInputStream(InputStream input, String charsetName, String baseUri, Parser parser) throws IOException  {
        if (input == null) // empty body
            return new 文档(baseUri);
        ...
        if (charsetName == null) { // determine from meta. safe first parse as UTF-8
            ...
            元素组 metaElements = doc.select("meta[http-equiv=content-type], meta[charset]");
            String foundCharset = null; // if not found, will keep utf-8 as best attempt
            for (元素 meta : metaElements) {
