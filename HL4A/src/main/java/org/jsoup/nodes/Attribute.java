...
public class Attribute implements Map.Entry<String, String>, Cloneable  {
    ...
    public String html() {
        ...
        try {
        	html(accum, (new 文档("")).outputSettings());
    ...
    protected static void html(String key, String val, Appendable accum, 文档.OutputSettings out) throws IOException {
        accum.append(key);
    ...
    protected void html(Appendable accum, 文档.OutputSettings out) throws IOException {
     ...
     */
    protected final boolean shouldCollapseAttribute(文档.OutputSettings out) {
        return shouldCollapseAttribute(key, val, out);
    }

    protected static boolean shouldCollapseAttribute(String key, String val, 文档.OutputSettings out) {
        // todo: optimize
        return (val == null || "".equals(val) || val.equalsIgnoreCase(key))
            && out.syntax() == 文档.OutputSettings.Syntax.html
