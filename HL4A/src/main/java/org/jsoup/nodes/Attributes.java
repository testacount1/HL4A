...
public class Attributes implements Iterable<Attribute>, Cloneable {
    ...
    public String html() {
        ...
        try {
            html(accum, (new 文档("")).outputSettings()); // output settings a bit funky, but this html() seldom used
    ...
    final void html(final Appendable accum, final 文档.OutputSettings out) throws IOException {
        final int sz = size;
        for (int i = 0; i < sz; i++) {
            ...
            if (!(out.syntax() == 文档.OutputSettings.Syntax.html
