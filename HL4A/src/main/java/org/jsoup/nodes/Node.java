...
public abstract class Node implements Cloneable {
     ...
     */
    public 文档 ownerDocument() {
        Node root = root();
        return (root instanceof 文档) ? (文档) root : null;
    }
    ...
    private void addSiblingHtml(int index, String html) {
        ...
        元素 context = parent() instanceof 元素 ? (元素) parent() : null;
    ...
    public Node wrap(String html) {
        ...
        if (wrapNode == null || !(wrapNode instanceof 元素)) // nothing to wrap with; noop
            return null;

        元素 wrap = (元素) wrapNode;
        元素 deepest = getDeepChild(wrap);
    ...
    private 元素 getDeepChild(元素 el) {
        List<元素> children = el.children();
        if (children.size() > 0)
    ...
    文档.OutputSettings getOutputSettings() {
        文档 owner = ownerDocument();
        return owner != null ? owner.outputSettings() : (new 文档("")).outputSettings();
    }
     ...
     */
    abstract void outerHtmlHead(final Appendable accum, int depth, final 文档.OutputSettings out) throws IOException;

    abstract void outerHtmlTail(final Appendable accum, int depth, final 文档.OutputSettings out) throws IOException;
    ...
    protected void indent(Appendable accum, int depth, 文档.OutputSettings out) throws IOException {
    ...
    private static class OuterHtmlVisitor implements NodeVisitor {
        ...
        private 文档.OutputSettings out;

        OuterHtmlVisitor(Appendable accum, 文档.OutputSettings out) {
            this.accum = accum;
            this.out = out;
            out.prepareEncoder();
        }
