...
public class Entities {
    ...
    private static final 文档.OutputSettings DefaultOutput = new 文档.OutputSettings();
     ...
     */
    public static String escape(String string, 文档.OutputSettings out) {
        if (string == null)
            return "";
    ...
    static void escape(Appendable accum, String string, 文档.OutputSettings out,
