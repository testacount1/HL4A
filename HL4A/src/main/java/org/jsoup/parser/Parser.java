...
public class Parser {
    ...
    public 文档 parseInput(String html, String baseUri) {
        errors = isTrackErrors() ? ParseErrorList.tracking(maxErrors) : ParseErrorList.noTracking();
        return treeBuilder.parse(new StringReader(html), baseUri, errors, settings);
    }

    public 文档 parseInput(Reader inputHtml, String baseUri) {
        errors = isTrackErrors() ? ParseErrorList.tracking(maxErrors) : ParseErrorList.noTracking();
     ...
     */
    public static List<Node> parseFragment(String fragmentHtml, 元素 context, String baseUri) {
     ...
     * @return list of nodes parsed from the input HTML. Note that the context element, if supplied, is not modified.
     */
    public static List<Node> parseFragment(String fragmentHtml, 元素 context, String baseUri, ParseErrorList errorList) {
        HtmlTreeBuilder treeBuilder = new HtmlTreeBuilder();
     ...
     */
    public static 文档 parseBodyFragmentRelaxed(String bodyHtml, String baseUri) {
