    ...
    Initial {
        boolean process(Token t, HtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
                ...
                if (d.isForceQuirks())
                    tb.getDocument().quirksMode(文档.QuirksMode.quirks);
    ...
    BeforeHead {
        boolean process(Token t, HtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
                ...
                元素 head = tb.insert(t.asStartTag());
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("html")) {
                        ...
                        元素 el = tb.insertEmpty(start);
                        // jsoup special: update base the frist time it is seen
                        if (name.equals("base") && el.hasAttr("href"))
                            tb.maybeSetBaseUri(el);
                    } else if (name.equals("meta")) {
                        元素 meta = tb.insertEmpty(start);
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("a")) {
                        if (tb.getActiveFormattingElement("a") != null) {
                            ...
                            // still on stack?
                            元素 remainingA = tb.getFromStack("a");
                            if (remainingA != null) {
                        ...
                        tb.framesetOk(false);
                        ArrayList<元素> stack = tb.getStack();
                        ...
                        if (tb.getDocument().quirksMode() != 文档.QuirksMode.quirks && tb.inButtonScope("p")) {
                            tb.processEndTag("p");
                        }
                        tb.insert(startTag);
                        tb.framesetOk(false);
                ...
                case EndTag:
                    ...
                    if (StringUtil.inSorted(name, Constants.InBodyEndAdoptionFormatters)) {
                        ...
                        for (int i = 0; i < 8; i++) {
                            元素 formatEl = tb.getActiveFormattingElement(name);
                            if (formatEl == null)
                            ...
                            元素 furthestBlock = null;
                            元素 commonAncestor = null;
                            ...
                            元素 node = furthestBlock;
                            元素 lastNode = furthestBlock;
                            for (int j = 0; j < 3; j++) {
                                if (tb.onStack(node))
                                ...
                                元素 replacement = new 元素(Tag.valueOf(node.nodeName(), ParseSettings.preserveCase), tb.getBaseUri());
                            ...
                            元素 adopter = new 元素(formatEl.tag(), tb.getBaseUri());
                        ...
                        元素 currentForm = tb.getFormElement();
