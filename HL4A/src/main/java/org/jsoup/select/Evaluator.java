...
public abstract class Evaluator {
     ...
     */
    public abstract boolean matches(元素 root, 元素 element);
    ...
    public static final class IsLastChild extends Evaluator {
		@Override
		public boolean matches(元素 root, 元素 element) {
			final 元素 p = element.parent();
			return p != null && !(p instanceof 文档) && element.elementSiblingIndex() == p.children().size()-1;
		}
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
    	...
    	public boolean matches(元素 root, 元素 element) {
    		final 元素 p = element.parent();
    		if (p == null || (p instanceof 文档)) return false;
		...
		protected abstract int calculatePosition(元素 root, 元素 element);
    }
    ...
    public static final class IsNthChild extends CssNthEvaluator {
		...
		protected int calculatePosition(元素 root, 元素 element) {
    ...
    public static class IsNthOfType extends CssNthEvaluator {
		...
		protected int calculatePosition(元素 root, 元素 element) {
			int pos = 0;
        	元素组 family = element.parent().children();
            for (元素 el : family) {
    ...
    public static final class IsFirstChild extends Evaluator {
    	...
    	public boolean matches(元素 root, 元素 element) {
    		final 元素 p = element.parent();
    		return p != null && !(p instanceof 文档) && element.elementSiblingIndex() == 0;
    	}
    ...
    public static final class IsRoot extends Evaluator {
    	@Override
    	public boolean matches(元素 root, 元素 element) {
    		final 元素 r = root instanceof 文档?root.child(0):root;
    		return element == r;
    	}
    	@Override
    	public String toString() {
    ...
    public static final class IsOnlyChild extends Evaluator {
		...
		public boolean matches(元素 root, 元素 element) {
			final 元素 p = element.parent();
			return p!=null && !(p instanceof 文档) && element.siblingElements().size() == 0;
		}
    	@Override
    	public String toString() {
    		return ":only-child";
